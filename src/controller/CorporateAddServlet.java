...
import java.sql.*;
/**
 * Servlet implementation class for Servlet: CorporateAddServlet
 *
 */
 public class CorporateAddServlet extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
   static final long serialVersionUID = 1L;
   
    /* (non-Java-doc)
	 * @see javax.servlet.http.HttpServlet#HttpServlet()
	 */
	public CorporateAddServlet() {
		super();
	}   	
