...
<td><c:out value="${row.MOB_NO}"/></td>
<td><c:out value="${row.CITY}"/></td> 
<td><c:out value="${row.STATE}"/></td>

<td><c:out value="${row.GENDER}"/></td>
<td><a href="UserDelete?y=${row.U_ID}" name="delete">Delete</a></td>
<td> <a href="UserUpdate.jsp?x=${row.U_ID}" name="update">Update</a></td>
</tr>
</c:forEach>
</table>
