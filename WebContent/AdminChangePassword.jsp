...
<li><h3><a href="AdminChangePassword.jsp">Change Password</a></h3></li>
...
<div id="wrap3" style="background-color":#EEEEEE;height:1000px;width:400px>
  ...
  <form method="get" action="Admin_ChangePasswordValidation">
                        <table border="0">
                            <th>
                                 <tr>
                                    <th>
                                     <label style="font-family:Bookman Old Style;font-size: medium">Please fill the form to change your password</label>
                                    </th>

                                </tr>
                                <tr>
                                    <td align="left" style="font-family: Bookman Old Style;font-size: medium">Username</td>
                                    <td><input type="text" name="username1" /></td>
                                </tr>

                                <tr>
                                    <td align="left" style="font-family: Bookman Old Style;font-size: medium">Old Password</td>
                                    <td><input type="password" name="oldpassword" /></td>
                                </tr>

                                <tr>
                                    <td align="left" style="font-family: Bookman Old Style;font-size: medium">New Password</td>
                                    <td><input type="password" name="newpassword" /></td>
                                </tr>

                                <tr>
                                            <td align="center"><input type="submit" value="Change Password" style="font-family: Bookman Old Style;font-size: medium;min-width: 200px" /></td>
